 ...
 */
package com.mycompany.sodukosolver;
...
public class Sudokufile extends javax.swing.JFrame {
    ...
    private void AssignTurn(JButton btn){//this function is responsible for putting value in empty box
        jButton82.setBackground(black);
        jButton83.setBackground(black);//All others will be in black color
        ...
        btn.setBackground(blue);// the button which we got in parameter will be in blue color
    }
    
    private void ResetGame(){//whenever you click on reset button this func will be executed
        ...
        for(int i = 0;i<9;i++){
            for(int j = 0;j<9;j++){//iterating in 2d matrix
                boolean flag = true;
                
                for(int k = 0;k<predefinedBtns.length;k++){// now iterate on predefined 1d array
                    if(btns[i][j]==predefinedBtns[k]){//if that gridElement is predefined, flag = false
                        flag = false;//no need to empty the predefined value
                    }
                }
                //no predefined cell found so empty the cell data
                if(flag){
                    btns[i][j].setText("");
    ...
    private void SeeSolution(){//this func fills the correct solution
        ...
        if(globalflag){//if you have clicked on show solution button
            globalflag = false;//now make it false
            jButton93.setText("Hide Solution");//and show the button hideSolution
            for(int i =0;i<9;i++){
                for(int j = 0;j<9;j++){
                    boolean flag = true;
                    for(int k = 0;k<predefinedBtns.length;k++){
                        if(btns[i][j]==predefinedBtns[k]){//check if its predefined button, then flag = false
                            flag = false;//
                        }
                    }
                    if(flag){//if was not a predefined button, replace its value with correctSolution(from solved board array
                        btns[i][j].setText(solvedBoard[i][j]);//set the solved value
                        btns[i][j].setBackground(white);
                        btns[i][j].setForeground(black);
                    }
                }
            }
        }else{//now hideSOlution button is visible
            jButton93.setText("Solution");//just update button, update variable and reset the game
            globalflag = true;
            ResetGame();
        }
    }
    
    private void check(){//this func is used to check the moves, are they correct
        ...
        };//editable buttons are here
        
        for(int i =0;i<9;i++){
            for(int j = 0;j<9;j++){
                String x = btns[i][j].getText();//get the value from i,j(from btn, filled by us)
                if(!x.equals(solvedBoard[i][j])){//if x Notequals correct solution then...
                    if(!x.equals("")){//if text is notEmpty, if its filled but its wrong(Empty hua to abhi bhara nhi h, can be filled)
                        btns[i][j].setBackground(red);//make the color as red
                    }
                }
            }
        }
        ...
        /*//create a globalFlag for it as well and toggle between checkmoves colors, because for now redColor is not removing
        if(globalflag){//if you have clicked on show solution button
            globalflag = false;//now make it false
            jButton93.setText("Hide Solution");//and show the button hideSolution
            for(int i =0;i<9;i++){
...
//    }// ye THA PEHLE
    ...
    private void initComponents() {
        ...
        jButton56.setBackground(new java.awt.Color(210, 230, 65));
        jButton56.setText("4");
        ...
        jButton58.setBackground(new java.awt.Color(210, 230, 65));
        jButton58.setText("3");
        ...
        jButton61.setBackground(new java.awt.Color(210, 230, 65));
        jButton61.setText("6");
        ...
        jButton62.setBackground(new java.awt.Color(210, 230, 65));
        jButton62.setText("8");
        ...
        jButton63.setBackground(new java.awt.Color(210, 230, 65));
        jButton63.setText("9");
        ...
        jButton47.setBackground(new java.awt.Color(210, 230, 65));
        jButton47.setText("9");
        ...
        jButton49.setBackground(new java.awt.Color(210, 230, 65));
        jButton49.setText("2");
        ...
        jButton50.setBackground(new java.awt.Color(210, 230, 65));
        jButton50.setText("8");
        ...
        jButton39.setBackground(new java.awt.Color(210, 230, 65));
        jButton39.setText("5");
        ...
        jButton43.setBackground(new java.awt.Color(210, 230, 65));
        jButton43.setText("1");
        jButton43.setToolTipText("");

        jButton44.setBackground(new java.awt.Color(210, 230, 65));
        jButton44.setText("8");
        ...
        jButton32.setBackground(new java.awt.Color(210, 245, 225));
        jButton32.setText("3");
        ...
        jButton33.setBackground(new java.awt.Color(210, 230, 65));
        jButton33.setText("4");
        ...
        jButton35.setBackground(new java.awt.Color(210, 230, 65));
        jButton35.setText("6");
        ...
        jButton19.setBackground(new java.awt.Color(210, 230, 65));
        jButton19.setText("7");
        ...
        jButton20.setBackground(new java.awt.Color(210, 230, 65));
        jButton20.setText("3");
        ...
        jButton21.setBackground(new java.awt.Color(210, 230, 65));
        jButton21.setText("4");

        jButton22.setBackground(new java.awt.Color(210, 230, 65));
        jButton22.setText("5");
        ...
        jButton24.setBackground(new java.awt.Color(210, 230, 65));
        jButton24.setText("9");
        ...
        jButton26.setBackground(new java.awt.Color(210, 230, 65));
        jButton26.setText("2");
        ...
        jButton10.setBackground(new java.awt.Color(210, 230, 65));
        jButton10.setText("5");
        ...
        jButton14.setBackground(new java.awt.Color(210, 230, 65));
        jButton14.setText("7");
        ...
        jButton15.setBackground(new java.awt.Color(210, 230, 65));
        jButton15.setText("8");
        ...
        jButton17.setBackground(new java.awt.Color(210, 230, 65));
        jButton17.setText("4");
        ...
        jButton4.setBackground(new java.awt.Color(210, 230, 65));
        jButton4.setText("4");
        ...
        jButton7.setBackground(new java.awt.Color(210, 230, 65));
        jButton7.setText("7");
        ...
        jButton9.setBackground(new java.awt.Color(210, 230, 65));
        jButton9.setText("6");
        ...
        jButton93.setBackground(new java.awt.Color(25, 204, 25));
        ...
        jButton83.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton94.setBackground(new java.awt.Color(250, 240, 200));
        ...
        jButton84.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton85.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton86.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton87.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton88.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton89.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton90.setBackground(new java.awt.Color(10, 20, 15));
        ...
        jButton91.setBackground(new java.awt.Color(204, 125, 204));
        ...
        jButton92.setBackground(new java.awt.Color(205, 50, 45));
        ...
        jButton82.setBackground(new java.awt.Color(55, 50, 230));
        ...
        jButton73.setBackground(new java.awt.Color(210, 230, 65));
        jButton73.setText("9");
        ...
        jButton75.setBackground(new java.awt.Color(210, 230, 65));
        jButton75.setText("6");
        ...
        jButton78.setBackground(new java.awt.Color(210, 230, 65));
        jButton78.setText("2");
        ...
        jButton65.setBackground(new java.awt.Color(210, 230, 65));
        jButton65.setText("5");
        ...
        jButton67.setBackground(new java.awt.Color(210, 230, 65));
        jButton67.setText("9");
        ...
        jButton68.setBackground(new java.awt.Color(210, 230, 65));
        jButton68.setText("6");
        ...
        jButton69.setBackground(new java.awt.Color(210, 230, 65));
        jButton69.setText("4");
        ...
        layout.setHorizontalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jButton91, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jButton93, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addGap(119, 119, 119))
        );
    ...
    private void jButton83ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton83ActionPerformed
        // TODO add your handling code here:
        turn = "2";//so we will keep on changing the turn according to button which we have clicked

        AssignTurn(jButton83);//also will pass this to AssignTurn to make it blue
    ...
    private void jButton85ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton85ActionPerformed
        ...
        AssignTurn(jButton85);
    }//GEN-LAST:event_jButton85ActionPerformed

    private void jButton86ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton86ActionPerformed
        // TODO add your handling code here:
        turn = "5";
        AssignTurn(jButton86);
    ...
    private void jButton90ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton90ActionPerformed
        ...
        AssignTurn(jButton90);
    }//GEN-LAST:event_jButton90ActionPerformed

    private void jButton91ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton91ActionPerformed
        // TODO add your handling code here:
        JFrame frame = new JFrame("Reset");//going to show a dialogue box, same thing in exit

        if(JOptionPane.showConfirmDialog(frame,
            "Confirm if you want to reset the game",
            "Sudoku Puzzle", JOptionPane.YES_NO_OPTION)
        ==
        JOptionPane.YES_NO_OPTION)//will create a new frame with title sudoku solver,. if yes reset then resetGame fumc will be called
        {
            ResetGame();
        }
    ...
    private void jButton92ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton92ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,
            ...
            "Sudoku Puzzle", JOptionPane.YES_NO_OPTION)
        ==
        JOptionPane.YES_NO_OPTION){//if true the only exit
        System.exit(0);//0 means end the termination
        }
