...
public class SudokuSolver extends javax.swing.JFrame {
    ...
    private void check(){
        ...
        for(int i =0;i<9;i++){
            for(int j = 0;j<9;j++){
                String x = btns[i][j].getText();
                if(!x.equals(solvedBoard[i][j])){
                    if(!x.equals("")){
    ...
    private void initComponents() {
        ...
        jButton91.setBackground(new java.awt.Color(205, 50, 45));
        jButton91.setText("Exit");
        ...
        jButton92.setBackground(new java.awt.Color(25, 204, 25));
        jButton92.setText("Solution");
        ...
        jButton93.setBackground(new java.awt.Color(250, 240, 200));
        jButton93.setText("Check Moves");
        ...
        jButton94.setBackground(new java.awt.Color(204, 125, 204));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(313, 313, 313)
                        .addComponent(jButton92, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(29, 29, 29)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButton93, javax.swing.GroupLayout.DEFAULT_SIZE, 115, Short.MAX_VALUE)
                        .addGap(119, 119, 119))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton91ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton91ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,
                "Confirm if you want to reset the same", 
    ...
    private void jButton92ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton92ActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame,
                "Confirm if you want to exit the same", 
                "Sudoku Puzzle", JOptionPane.YES_NO_OPTION)
                == 
           JOptionPane.YES_NO_OPTION){
            System.exit(0);
